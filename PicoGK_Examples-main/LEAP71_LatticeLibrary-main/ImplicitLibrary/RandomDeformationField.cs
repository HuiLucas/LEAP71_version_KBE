...
// 
// This project is developed and maintained by LEAP 71 - Â© 2023 by LEAP 71
// https://leap71.com
//
	...
	namespace LatticeLibrary
    {
        public class RandomDeformationField
		{
                ...
                float fMaxValue)
			{
                ...
                // preview
                Sh.PreviewPoint(new (), 0.5f, Cp.strRed);
                Sh.PreviewBoxWireframe(m_oBBox, Cp.strRed);
                ...
                for (int iX = 1; iX <= m_nXSamples; iX++)
                {
                    for (int iY = 1; iY <= m_nYSamples; iY++)
                    {
                        for (int iZ = 1; iZ <= m_nZSamples; iZ++)
                        {
                            ...
                            Sh.PreviewBoxWireframe(oSubCube, Cp.strBlack);
                        }
                    }
                }
                ...
                for (int iX = 0; iX <= m_nXSamples; iX++)
                {
                    for (int iY = 0; iY <= m_nYSamples; iY++)
                    {
                        for (int iZ = 0; iZ <= m_nZSamples; iZ++)
                        {
                            ...
                            Sh.PreviewPoint(vecPt, 1.0f, Cp.strRandom());
