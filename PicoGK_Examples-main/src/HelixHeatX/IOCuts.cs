    ...
    namespace CoolCube
    {
        public partial class HelixHeatX
        {
            ...
            Voxels voxGetIOCuts()
            {
                ...
                aVoxelList.Add(oCut1.oConstructVoxels());
                aVoxelList.Add(oCut2.oConstructVoxels());
                aVoxelList.Add(oCut3.oConstructVoxels());
                aVoxelList.Add(oCut4.oConstructVoxels());
                ...
                Sh.PreviewVoxels(voxIOCuts, Cp.strRed, 0.3f);
                return voxIOCuts;
            }
            ...
            Voxels voxGetIOScrewCuts()
            {
                ...
                Sh.PreviewVoxels(voxScrews, Cp.strRed, 0.4f);
                return voxScrews;
            }
		}
	}
