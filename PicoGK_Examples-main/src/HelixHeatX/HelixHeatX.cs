    ...
    namespace CoolCube
    {
        public partial class HelixHeatX
        {
            ...
            protected HelixHeatX()
            {
                ...
                Sh.PreviewBoxWireframe(         oInnerBox,      Cp.strBlack);
                Sh.PreviewCylinderWireframe(    oFirstInlet,    Cp.strRed);
                Sh.PreviewCylinderWireframe(    oSecondInlet,   Cp.strRed);
                Sh.PreviewCylinderWireframe(    oFirstOutlet,   Cp.strRed);
                Sh.PreviewCylinderWireframe(    oSecondOutlet,  Cp.strRed);
                ...
                m_voxBounding               = oOuterBox.oConstructVoxels();
                Sh.PreviewBoxWireframe(oOuterBox, Cp.strBlack);
            ...
            protected Voxels voxConstruct()
            {
                ...
                Sh.PreviewVoxels(voxAllCornerFins, Cp.strWarning, 0.5f);
                ...
                Sh.PreviewVoxels(voxAllStraightFins, Cp.strToothpaste, 0.5f);
                ...
                Sh.PreviewVoxels(voxFins, Cp.strRock);


                Voxels voxStructure         = voxGetOuterStructure();
                Sh.PreviewVoxels(voxStructure, Cp.strRock, 0.3f);
                ...
                Sh.PreviewVoxels(voxHotFluidVoid, Cp.strPitaya, 0.5f);
                Library.oViewer().RequestScreenShot(Sh.strGetExportPath(Sh.EExport.TGA, $"Screenshot_03"));
                Sh.PreviewVoxels(voxCoolFluidVoid, Cp.strFrozen, 0.5f);
                ...
                Sh.PreviewVoxels(voxScrewHoles, Cp.strRed);
                Sh.PreviewVoxels(voxFlangeScrewCutters, Cp.strRed, 0.4f);
                Library.oViewer().RequestScreenShot(Sh.strGetExportPath(Sh.EExport.TGA, $"Screenshot_05"));


                voxFlange.Fillet(5f);
                voxFlange.Smoothen(0.5f);
                Sh.PreviewVoxels(voxFlange, Cp.strGray, 0.6f);
                ...
                Sh.PreviewVoxels(voxResult, Cp.strRock);
                Uf.Wait(0.1f);
